...
# Custom least squares solver
def least_squares(X, z):
    """Solve for coefficients using the least squares method."""
...
for i in range(len(x)):
    ...
    # Solve for coefficients using the custom least squares function
    coefficients = least_squares(X_train, z_train)
